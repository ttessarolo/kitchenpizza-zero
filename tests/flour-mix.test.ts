...
describe('FlourManager — blendFlourProperties with gram weights', () => {
  ...
  it('equal weights match estimateBlendW', () => {
    ...
    const estimated = estimateBlendW(['gt_00_deb', 'gt_00_for'], catalog)
